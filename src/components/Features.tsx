  ...
  const features = [
    {
      ...
      description: "Allenamenti basati su evidenze scientifiche e tecniche professionali della corsa su pista applicate alla strada."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Piani che si adattano ai tuoi impegni, non il contrario. Corri quando vuoi, senza sacrificare risultati."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Feedback personalizzati e supporto pedagogico per ogni fase del tuo percorso di crescita."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Non solo performance: migliora le tue abilità mentali e fisiche per una vita più sana."
    }
  ];
